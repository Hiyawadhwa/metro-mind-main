...
export default function LandingPage() {
  ...
  const quickLinks = [
  { name: t("footer.links.home"), href: "/en" },
  { name: t("footer.links.about"), href: "/en/about" },
  { name: t("footer.links.services"), href: "#features" },
  { name: t("footer.links.contact"), href: "/en/contact" },
];
  ...
  { name: t("contact"), href: "/en/contact" },
  { name: t("security"), href: "/en/security" },
].map((item, index) => (
                <motion.a
                  key={item.name}
                  href={item.href}
